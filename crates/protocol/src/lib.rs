...
pub use chat::{
    ...
    PluginCommand, SidebarMessage, SkillCommand, SkillsUpdateRequest, SkillsUpdateResponse,
    StopGeneration, StreamChunk, StreamEnd, SystemCommand, SystemResponse, TabInfo, ThinkingEvent,
