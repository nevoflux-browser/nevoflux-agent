...
const MIGRATIONS: &[(&str, &str)] = &[
    ...
    (
        "025_loop_iteration_final_text",
        include_str!("migrations/025_loop_iteration_final_text.sql"),
    ),
    (
        "026_loop_gate",
        include_str!("migrations/026_loop_gate.sql"),
    ),
    (
        "027_loop_verify",
        include_str!("migrations/027_loop_verify.sql"),
    ),
];
...
mod tests {
    ...
    fn test_migrations_idempotent() {
        ...
        let count: i32 = conn
            ...
            .unwrap();
        // 26 SQL migrations (001-012, 014, 015, 016, 017, 018, 019, 020, 021, 022, 023, 024, 025, 026, 027) + 1
        // Rust post-migration marker (016b_composition_assets_data) = 27.
        assert_eq!(count, 27);
    }
